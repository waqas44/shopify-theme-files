...
document.addEventListener("alpine:init", function () {
  alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].store("header", {
    watchingItems: alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].$persist([]),
    get watchlistItems() {
  ...
  alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data("productItem", function (product) {
    return {
      id: product.id,
      product: product,
      quantity: 1,
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkglasseffects"] = self["webpackChunkglasseffects"] || [];
